...
var loadingMessages = ["puliendo antiguedades...", "encendiendo estrellas...", "clasificando fotos...", "restaurando cuadros antiguos...", "dibujando constelaciones...", "arrancando trenes...", "afinando guitarras...", "calentando motores..."];
...
function showLoading(t, container, style) {
    try {
        if (t) {
            ...
            var loadingFrame = '<div class="loadingFrame ' + style + '">' + '<div class="spinningCogs">' + '<i class="left-cog fa fa-cog fa-spin"></i>' + '<i class="center-cog fa fa-cog fa-spin-reverse"></i>' + '<i class="right-cog fa fa-cog fa-spin"></i>' + '</div>' + '</div>';
